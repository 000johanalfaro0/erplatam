...
export function GastosClient({
  ...
  initialData: Paginated<Expense> & { totalAmountCents: number };
}) {
  ...
  const { data, isLoading } = useQuery({
     ...
     * filtros, así que sin ella TanStack Query aplicaría estos mismos datos a
     * la consulta filtrada, mostrando resultados que no corresponden al
     * filtro elegido.
     */
    initialData:
      !debounced && !categoryId && page === 1 ? initialData : undefined,
  });
